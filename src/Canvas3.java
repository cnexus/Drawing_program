...
public class Canvas3 extends JFrame{
	/**
	 * 
	 */
...
//	public static boolean filled;
	...
	public void eventOutput(String eventDescription, Point p){
	}
	...
	public synchronized void mouseReleased(MouseEvent e) {
		...
		//mouseClicked = true;
		System.out.println("Mouse released at "+ end);
...
//				}
	...
	public static void main(String[] args) {
		Canvas2 window = new Canvas2("Drawing Canvas");
	...
	public void mouseClicked(MouseEvent e) {
		eventOutput("Mouse clicked at ", e.getPoint());
	}

	public void mouseEntered(MouseEvent e) {
		eventOutput("Mouse entered at ", e.getPoint());
	}

	public void mouseExited(MouseEvent e) {
		eventOutput("Mouse exited at ", e.getPoint());
	}
}
